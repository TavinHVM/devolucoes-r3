    ...
    <aside className="w-60 bg-gray-800 text-white flex flex-col py-8 px-4 min-h-screen">
      <div className="flex-1 flex flex-col">
        ...
        <nav className="flex flex-col gap-4">
          <Link href="/" prefetch className="hover:bg-gray-700 rounded px-3 py-2 transition">Início</Link>
      ...
      <button
        className="mt-8 bg-red-600 hover:bg-red-700 text-white rounded px-3 py-2 transition cursor-pointer"
