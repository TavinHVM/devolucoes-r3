                          ...
                          <td className="px-2 py-2">
                            {s.status === 'Pendente' && (
                              <div className="flex gap-2">
                                <Button onClick={() => aprovarSolicitacao(s.id)} className="bg-green-600 hover:bg-green-700 text-white">Aprovar</Button>
                                <Button
                                  onClick={() => recusarSolicitacao(s.id, prompt('Motivo da recusa:') || '')}
                                  variant="destructive"
